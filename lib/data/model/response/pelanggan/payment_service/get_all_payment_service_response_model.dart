...
class GetAllPaymentServicetResponseModel {
    final int? paymentId;
    ...
    GetAllPaymentServicetResponseModel({
        this.paymentId,
        this.confirmationId,
        this.totalAmount,
        this.paymentStatus,
    ...
    factory GetAllPaymentServicetResponseModel.fromJson(String str) => GetAllPaymentServicetResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory GetAllPaymentServicetResponseModel.fromMap(Map<String, dynamic> json) => GetAllPaymentServicetResponseModel(
