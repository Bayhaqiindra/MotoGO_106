...
class GetallAdminPaymentSparepartResponseModel {
    final int? paymentId;
    ...
    GetallAdminPaymentSparepartResponseModel({
        this.paymentId,
        this.transactionId,
    ...
    factory GetallAdminPaymentSparepartResponseModel.fromJson(String str) => GetallAdminPaymentSparepartResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory GetallAdminPaymentSparepartResponseModel.fromMap(Map<String, dynamic> json) => GetallAdminPaymentSparepartResponseModel(
